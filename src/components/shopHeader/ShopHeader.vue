<template>
  <div class="shopHeader">
    ...
    <div class="shop-content">
      ...
      <div class="header-content" v-on:click="toggleShopShow">
    ...
    <div class="shop-header-discounts" v-on:click="supportsShopShow">
    ...
    <div class="shop-brief-modal" v-show="shopShow">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" v-on:click="toggleShopShow">
    ...
    <div class="activity-sheet" v-show="supportsShow">
      <div class="activity-sheet-content">
        ...
        <ul class="list">
          <li class="activity-item" :class="supportClasses[s.type]" v-for="(s, index) in info.supports" :key="index">
            <span class="content-tag">
        ...
        <div class="activity-sheet-close" v-on:click="supportsShopShow">
          <i class="iconfont icon-close"></i>
        </div>
      </div>
